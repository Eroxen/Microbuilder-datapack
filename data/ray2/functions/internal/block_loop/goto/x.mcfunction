scoreboard players operation #ray2.goto_distance ray2.calc = #ray2.temp.x ray2.calc

scoreboard players operation #ray2.pos.x ray2.calc = #ray2.next_block_start.x ray2.calc
scoreboard players operation #ray2.block.x ray2.calc += #ray2.l.sign.x ray2.calc
