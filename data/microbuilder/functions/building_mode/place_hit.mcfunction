...
execute if data storage microbuilder:calc place{success:0b} run function microbuilder:place/move_to_next_block
execute if data storage microbuilder:calc place{success:0b} at @s align xyz positioned ~0.5 ~0.5 ~0.5 unless entity @e[type=marker,tag=microbuilder.scene_manager,distance=..0.1] run function microbuilder:place/new_scene_manager
execute if data storage microbuilder:calc place{success:0b} at @s align xyz positioned ~0.5 ~0.5 ~0.5 as @e[type=marker,tag=microbuilder.scene_manager,distance=..0.1,limit=1] run function microbuilder:place/scene_manager_call

execute if data storage microbuilder:calc place{success:1b} at @s run function microbuilder:registry/api/play_place_sound
