...
execute if score contents microbuilder.calc matches 1.. run data modify storage microbuilder:calc set_element.z2[0].data set from storage microbuilder:calc scene_element
