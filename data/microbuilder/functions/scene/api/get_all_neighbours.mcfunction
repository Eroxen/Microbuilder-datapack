...
execute if score y microbuilder.calc matches 0.. run function microbuilder:scene/api/get_element
execute if score y microbuilder.calc matches ..-1 run data modify storage microbuilder:calc get_neighbours.stack.scene set from storage microbuilder:calc scene
execute if score y microbuilder.calc matches ..-1 positioned ~ ~-1 ~ run function microbuilder:scene/internal/get_neighbours/overshoot
execute if score y microbuilder.calc matches ..-1 run data modify storage microbuilder:calc scene set from storage microbuilder:calc get_neighbours.stack.scene
execute if data storage microbuilder:calc scene_element.state run function microbuilder:scene/internal/get_neighbours/get_neighbour_details
execute if data storage microbuilder:calc scene_element.state run data modify storage microbuilder:calc neighbours.down set from storage microbuilder:calc get_neighbours.neighbour
