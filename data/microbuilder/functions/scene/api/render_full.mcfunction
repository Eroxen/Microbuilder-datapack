...
scoreboard players set #x_max microbuilder.calc 360360
scoreboard players set #y_max microbuilder.calc 360360
scoreboard players set #z_max microbuilder.calc 360360
