...
execute if data storage microbuilder:registry property{type:"horizontally_rotatable_add1"} run function microbuilder:place/get_state/horizontally_rotatable_add1
...
execute if data storage microbuilder:registry property{type:"wall"} run function microbuilder:place/get_state/wall/new
execute if data storage microbuilder:registry property{type:"pane"} run function microbuilder:place/get_state/pane/new
execute if data storage microbuilder:registry property{type:"h_and_v_rot"} run function microbuilder:place/get_state/h_and_v_rot
execute if data storage microbuilder:registry property{type:"torch"} run function microbuilder:place/get_state/torch
execute if data storage microbuilder:registry property{type:"lantern"} run function microbuilder:place/get_state/lantern
execute if data storage microbuilder:registry property{type:"rod"} run function microbuilder:place/get_state/rod
