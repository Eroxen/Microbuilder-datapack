scoreboard players set #place.connect.east microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.east.property{type:"wall"} run scoreboard players set #place.connect.east microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.east.property{type:"pane"} run scoreboard players set #place.connect.east microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.east.state{full:1b} run scoreboard players set #place.connect.east microbuilder.calc 1
...
scoreboard players set #place.connect.north microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.north.property{type:"wall"} run scoreboard players set #place.connect.north microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.north.property{type:"pane"} run scoreboard players set #place.connect.north microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.north.state{full:1b} run scoreboard players set #place.connect.north microbuilder.calc 1
...
scoreboard players set #place.connect.south microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.south.property{type:"wall"} run scoreboard players set #place.connect.south microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.south.property{type:"pane"} run scoreboard players set #place.connect.south microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.south.state{full:1b} run scoreboard players set #place.connect.south microbuilder.calc 1
...
scoreboard players set #place.connect.west microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.west.property{type:"wall"} run scoreboard players set #place.connect.west microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.west.property{type:"pane"} run scoreboard players set #place.connect.west microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.west.state{full:1b} run scoreboard players set #place.connect.west microbuilder.calc 1
...
scoreboard players operation #place.state microbuilder.calc = #place.connect.east microbuilder.calc
scoreboard players operation #place.state microbuilder.calc *= #temp.op microbuilder.calc
scoreboard players operation #place.state microbuilder.calc += #place.connect.north microbuilder.calc
scoreboard players operation #place.state microbuilder.calc *= #temp.op microbuilder.calc
scoreboard players operation #place.state microbuilder.calc += #place.connect.south microbuilder.calc
...
scoreboard players operation #place.state microbuilder.calc += #place.connect.up microbuilder.calc
scoreboard players set #temp.op microbuilder.calc 3
scoreboard players operation #place.state microbuilder.calc *= #temp.op microbuilder.calc
scoreboard players operation #place.state microbuilder.calc += #place.connect.west microbuilder.calc