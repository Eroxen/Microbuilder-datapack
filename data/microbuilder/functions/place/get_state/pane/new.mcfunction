...
execute if data storage microbuilder:calc neighbours.east.property{type:"pane"} run scoreboard players set #place.connect microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.east.property{type:"wall"} run scoreboard players set #place.connect microbuilder.calc 1
...
scoreboard players set #place.connect microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.north.property{type:"pane"} run scoreboard players set #place.connect microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.north.property{type:"wall"} run scoreboard players set #place.connect microbuilder.calc 1
...
scoreboard players set #place.connect microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.south.property{type:"pane"} run scoreboard players set #place.connect microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.south.property{type:"wall"} run scoreboard players set #place.connect microbuilder.calc 1
...
scoreboard players set #place.connect microbuilder.calc 0
execute if data storage microbuilder:calc neighbours.west.property{type:"pane"} run scoreboard players set #place.connect microbuilder.calc 1
execute if data storage microbuilder:calc neighbours.west.property{type:"wall"} run scoreboard players set #place.connect microbuilder.calc 1
