...
execute if data storage ray2:api result.normal{sign:-1} run scoreboard players add #place.shift microbuilder.calc 4
execute if data storage ray2:api result.normal{sign:1} run scoreboard players remove #place.shift microbuilder.calc 4
...
scoreboard players operation #place.shift microbuilder.calc /= scale microbuilder.calc
scoreboard players operation #place.shift microbuilder.calc += #place.block microbuilder.calc
execute if data storage ray2:api result.normal{sign:-1} run scoreboard players remove #place.shift microbuilder.calc 2
execute if data storage ray2:api result.normal{sign:1} run scoreboard players add #place.shift microbuilder.calc 2
